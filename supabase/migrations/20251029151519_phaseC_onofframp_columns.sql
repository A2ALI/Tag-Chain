-- Tag Chain PRD4 Phase C Step 3: Add missing columns to on/off-ramp tables
-- Date: 2025-10-29

-- Add missing columns to onchain_inbound_events table
...
-- Add missing columns to onchain_withdrawals table
